...
const jake = {
  ...
  repository: {
    comments: { name: "comment.line.number-sign.jake", match: "#.*$" },
    imports: {
      patterns: [
        {
    ...
    "global-directives": {
      patterns: [
        ...
        },
        {
          ...
          match: "^(@default)\\s*$",
          captures: { 1: { name: "keyword.control.directive.jake" } },
        },
      ],
    },
    variables: {
    ...
    "condition-expression": {
      patterns: [
        {
          match:
            "\\b(env|exists|eq|neq|is_watching|is_dry_run|is_verbose)\\s*\\(",
          captures: { 1: { name: "support.function.condition.jake" } },
        },
        { include: "#strings" },
        { include: "#jake-variables" },
        { match: "[a-zA-Z_][a-zA-Z0-9_]*", name: "variable.other.jake" },
      ],
    },
    "shell-line": {
      patterns: [
      ...
      patterns: [
        {
          ...
          patterns: [
            {
              match:
                "\\b(dirname|basename|extension|without_extension|without_extensions|absolute_path|abs_path|uppercase|lowercase|trim|home|local_bin|shell_config|env|exists|eq|neq|is_watching|is_dry_run|is_verbose)\\s*\\(",
    ...
    "shell-variables": {
      patterns: [
        ...
        { match: "\\$[0-9@]", name: "variable.language.positional.jake" },
      ],
    },
    strings: {
      patterns: [
