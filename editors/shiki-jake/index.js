...
/**
 * Unified Jakefile API for Shiki
 */
const Jakefile = {
  /** TextMate grammar for Shiki */
  grammar: jakeGrammar,

  /**
   * Register Jake syntax with a Shiki highlighter instance
   * @param {Object} highlighter - Shiki highlighter instance
   * @returns {Promise<Object>} Jakefile object (chainable)
   */
  async register(highlighter) {
    await highlighter.loadLanguage(jakeGrammar);
    return this;
  }
};

// Named exports
export { Jakefile, jakeGrammar as grammar };

// Default export (grammar for backwards compatibility)
export default jakeGrammar;
